...
public class provaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAM", "END_PROGRAM", "TYPE", "END_TYPE", "VAR", "END_VAR", "FUNC", 
			"END_FUNC", "ACTION", "END_ACTION", "IF", "THEN", "ELSEIF", "ELSE", "ENDIF", 
			"WHILE", "END_WHILE", "FOR", "IN", "DO", "END_FOR", "READ", "WRITE", 
			"WRITELN", "RETURN", "BOOLEAN", "INTEGER", "REAL", "VECTOR", "TUPLE", 
			"END_TUPLE", "RANG", "ENT", "ENTSOR", "NEG", "ASSIGN", "PLUS", "MINUS", 
			"MULT", "DIV", "INT_DIV", "MOD", "EQ", "NEQ", "LT", "LEQ", "GT", "GEQ", 
			"AND", "OR", "NOT", "DOT", "COMMA", "SEMICOLON", "COLON", "LPAREN", "RPAREN", 
			"LBRACKET", "RBRACKET", "ID", "NUMBER", "REAL_NUMBER", "BOOLEAN_LITERAL", 
